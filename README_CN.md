...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) a057b7801d0f36c54942cb618659bab6
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) a057b7801d0f36c54942cb618659bab6
```
方式3：手动下载二进制文件
...
cursor-vip a057b7801d0f36c54942cb618659bab6;
# Windows
